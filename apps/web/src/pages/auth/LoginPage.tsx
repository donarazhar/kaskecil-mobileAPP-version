...
export default function LoginPage() {
    ...
    const onSubmit = async (data: LoginValues) => {
        try {
            ...
            setError("root", {
                message: error?.response?.data?.message || error?.message || "Gagal masuk. Periksa kembali email dan password anda."
            })
        }
    }
        ...
        <div className="space-y-8">
            ...
            <div className="text-center text-sm text-gray-500">
                <div className="text-gray-500">
                    ...
                    <a href="mailto:donarazhar@al-azhar.or.id" className="font-medium text-[#0053C5] hover:text-[#0047AB] transition-colors">
                        donarazhar@al-azhar.or.id
                    </a>
                    {' '}atau whatsapp{' '}
                    <a href="https://wa.me/6288214740182" target="_blank" rel="noopener noreferrer" className="font-medium text-[#0053C5] hover:text-[#0047AB] transition-colors">
                        0882-1474-0182
                    </a>
                </div>
            </div>
