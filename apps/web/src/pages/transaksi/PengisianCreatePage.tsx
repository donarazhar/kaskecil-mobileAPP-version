...
export default function PengisianCreatePage() {
    ...
    // Auto-select MA-112 (Pengisian Kas) when mata anggaran data loads
    useEffect(() => {
        if (!isMataAnggaranLoading && mataAnggaran.length > 0 && !formData.kode_matanggaran) {
            const pengisianKas = mataAnggaran.find((ma: any) => ma.akun_aas?.kode_akun === '1.1.2');
            if (pengisianKas) {
                setFormData(prev => ({
                    ...prev,
                    kode_matanggaran: pengisianKas.kode_matanggaran,
                }));
            }
        }
    }, [mataAnggaran, isMataAnggaranLoading]);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error('Error creating pengisian:', error);
            alert(error?.response?.data?.message || 'Gagal menyimpan data pengisian');
        }
    };
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold text-gray-900 tracking-tight flex items-center gap-3">
                        ...
                        Tambah Pengisian Kas
                    </h1>
                    <p className="text-gray-500 mt-1">Buat transaksi pengisian kas kecil baru</p>
                </div>
            </div>
            ...
            <Card className="border-none shadow-xl">
                ...
                <CardContent className="p-6">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        {/* Mata Anggaran - Default to MA-112 Pengisian Kas */}
