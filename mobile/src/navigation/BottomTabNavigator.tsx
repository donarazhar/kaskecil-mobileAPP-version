...
import AkunAASScreen from "../screens/menu/AkunAASScreen";
import MataAnggaranScreen from "../screens/menu/MataAnggaranScreen";
  ...
  return (
    <TransaksiStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <TransaksiStack.Screen
        ...
        component={TransaksiCreateScreen}
      />
      <TransaksiStack.Screen
...
function MenuNavigator() {
  return (
    <MenuStack.Navigator screenOptions={{ headerShown: false }}>
      ...
      <MenuStack.Screen name="AkunAAS" component={AkunAASScreen} />
      <MenuStack.Screen name="MataAnggaran" component={MataAnggaranScreen} />
    </MenuStack.Navigator>
  );
}
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ color, size, focused }) => (
            <View
              className={`p-1.5 rounded-xl ${focused ? "bg-blue-100" : ""}`}
            >
