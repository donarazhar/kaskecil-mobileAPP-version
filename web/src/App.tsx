    ...
    <div className="space-y-6">
        ...
        <div className="card-modern p-12 text-center">
            <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#0053C5]/10 flex items-center justify-center">
                <svg className="w-8 h-8 text-[#0053C5]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    return (
        <Routes>
            ...
            <Route element={<DashboardLayout />}>
                ...
                <Route path="/drafts/create" element={<PlaceholderPage title="Buat Pengajuan" />} />
                ...
                <Route path="/master/mata-anggaran" element={<MataAnggaranListPage />} />
            </Route>
